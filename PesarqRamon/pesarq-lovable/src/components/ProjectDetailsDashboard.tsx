...
import { ArrowLeft, Package, FileText, Search, Calendar, TrendingUp } from "lucide-react";
...
export function ProjectDetailsDashboard({ project, onBack }: ProjectDetailsDashboardProps) {
                ...
                {project.goals?.map((goal) => (
                  <div key={goal.id} className="border rounded-lg p-4">
                    ...
                    {goal.products && goal.products.length > 0 && (
                      <div className="mt-3">
                        <h5 className="text-sm font-medium mb-1">Produtos:</h5>
                        <div className="flex flex-wrap gap-1">
